...
export const ProductCategoryProvider = ({ children }) => {
  ...
  return <ProductCategoryContext.Provider value={{ categories, loading, error, fetchCategories, createCategory, updateCategory, deleteCategory }}>{children}</ProductCategoryContext.Provider>
